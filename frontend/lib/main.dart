...
class GuidePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) => _SimplePage(
        ...
        children: [
          ...
          const SizedBox(height: 18),
          _GuideSection(number: '§ 02', title: 'Modalités d’Évaluation & Formules de Calcul', kicker: 'PLANS D’ÉVALUATION', child: const _EvaluationRules()),
          const SizedBox(height: 18),
